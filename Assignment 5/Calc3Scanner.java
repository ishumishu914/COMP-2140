...
public static Symbol next_token() throws java.io.IOException {
  ...
  return s;
	...
	Calc3Scanner (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	Calc3Scanner (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
...
"11:10,10,11:2,0,11:26,5,6,2,1,11:4,8:10,11,4,11,3,11:3,9:26,7:4,9,7,9:26,11" +
":5,12:2")[0];

	private int yy_rmap[] = unpackFromString(1,12,
"0,1:6,2,3,1:3")[0];

	private int yy_nxt[][] = unpackFromString(4,13,
"-1,1,2,3,4,5,6,7,8,7,9,10,11,-1:21,7:2,-1:11,8,-1:4");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -7:
						break;
					case 7:
						{return new Symbol(Calc2Symbol.ID, yytext()); }
					case -8:
						break;
					case 8:
						{ return new Symbol(Calc2Symbol.NUMBER, new Integer(yytext()));}
					case -9:
						break;
					case 9:
